...
cart_type = input("\033[92mKart Tipini Seç Knk. (visa/master) => ").lower()
count = int(input("\033[93mKaç tane card üretilsin knk? (1,2,500,10000) => "))

if cart_type == "visa":
	with open('/sdcard/download/ccler.txt', 'a') as f:
    ...
    print("geçersiz kart  (VİSA/MASTER)")